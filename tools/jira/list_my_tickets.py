...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--include-done", action="store_true", help="Include done tickets"
    )
    parser.add_argument(
        "--max-results", type=int, default=200, help="Max results (default: 200)"
    )
    parser.add_argument(
    ...
    tickets = list_my_tickets(
        j, args.include_done, args.max_results, args.include_body, args.include_comments
    )
